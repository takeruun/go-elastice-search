...
type ComplexityRoot struct {
	...
	Mutation struct {
		CreateItem func(childComplexity int, title string, description string) int
		DeleteItem func(childComplexity int, id string) int
		Empty      func(childComplexity int) int
		UpdateItem func(childComplexity int, id string, title *string, description *string) int
	}

	Query struct {
		Empty       func(childComplexity int) int
		SearchItems func(childComplexity int, where *model.ItemWhere) int
	}
}
...
type QueryResolver interface {
	Empty(ctx context.Context) (*string, error)
	SearchItems(ctx context.Context, where *model.ItemWhere) ([]*model.Item, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.createItem":
		...
		return e.complexity.Mutation.CreateItem(childComplexity, args["title"].(string), args["description"].(string)), true
	...
	case "Mutation.updateItem":
		...
		return e.complexity.Mutation.UpdateItem(childComplexity, args["id"].(string), args["title"].(*string), args["description"].(*string)), true
	...
	case "Query.searchItems":
		...
		return e.complexity.Query.SearchItems(childComplexity, args["where"].(*model.ItemWhere)), true
...
type Mutation {
  _empty: String
	...
	{Name: "../../schemas/item.graphql", Input: `type Item {
  id: ID!
  title: String!
  description: String!
}
...
func (ec *executionContext) field_Query_searchItems_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 *model.ItemWhere
	if tmp, ok := rawArgs["where"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("where"))
		arg0, err = ec.unmarshalOItemWhere2ᚖappᚋgraphᚋmodelᚐItemWhere(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createItem(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().CreateItem(rctx, fc.Args["title"].(string), fc.Args["description"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation_updateItem(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateItem(rctx, fc.Args["id"].(string), fc.Args["title"].(*string), fc.Args["description"].(*string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Query_searchItems(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().SearchItems(rctx, fc.Args["where"].(*model.ItemWhere))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	res := resTmp.([]*model.Item)
	fc.Result = res
	return ec.marshalNItem2ᚕᚖappᚋgraphᚋmodelᚐItemᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputItemWhere(ctx context.Context, obj interface{}) (model.ItemWhere, error) {
	var it model.ItemWhere
...
func (ec *executionContext) marshalNItem2appᚋgraphᚋmodelᚐItem(ctx context.Context, sel ast.SelectionSet, v model.Item) graphql.Marshaler {
	return ec._Item(ctx, sel, &v)
}

func (ec *executionContext) marshalNItem2ᚕᚖappᚋgraphᚋmodelᚐItemᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Item) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNItem2ᚖappᚋgraphᚋmodelᚐItem(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNItem2ᚖappᚋgraphᚋmodelᚐItem(ctx context.Context, sel ast.SelectionSet, v *model.Item) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalOItemWhere2ᚖappᚋgraphᚋmodelᚐItemWhere(ctx context.Context, v interface{}) (*model.ItemWhere, error) {
	if v == nil {
		return nil, nil
	}
	res, err := ec.unmarshalInputItemWhere(ctx, v)
	return &res, graphql.ErrorOnPath(ctx, err)
}
